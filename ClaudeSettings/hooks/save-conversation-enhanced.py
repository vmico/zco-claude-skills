...
def generate_markdown(messages: List[Dict[str, Any]],
    ...
    if tool_calls:
        ...
        for idx, call in enumerate(tool_calls, 1):
            ...
            lines.append("```json\n")
            # lines.append(json.dumps(call.get('input', {}), indent=2, ensure_ascii=False))
...
def save_conversation(transcript_path: str, project_dir: str):
    ...
    try:
        ...
        # 确保 _.claude_hist 目录存在
        hist_dir = Path(project_dir) / "_.claude_hist"
